...
void loop()
{
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    Serial.print(i);
    Serial.print(": ");
    Serial.print(inputdata[(i<<1)+2] & 0x01 ? ">" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x02 ? "<" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x04 ? "v" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x08 ? "^" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x10 ? "T" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x20 ? "S" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x40 ? "Y" : "-");
    Serial.print(inputdata[(i<<1)+2] & 0x80 ? "B" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x01 ? "x" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x02 ? "x" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x04 ? "x" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x08 ? "x" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x10 ? "R" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x20 ? "L" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x40 ? "X" : "-");
    Serial.print(inputdata[(i<<1)+3] & 0x80 ? "A" : "-");
    Serial.print("\r\n");
  }
